...
function VendorDetails(
  ...
  return (
    <section className={className}>
      ...
      <header>
        <h2 className="flex justify-between mb-8 text-lg font-medium text-gray-900 dark:text-gray-100">
          ...
          {user.vendor?.status === "pending" && (
            <span className="badge badge-earning">{user.vendor.status_label}</span>
          )}
      ...
      <div className="">
        {!user.vendor && (
          <PrimaryButton disabled={processing} onClick={ev=> setShowBecomeVendorConfirmation(true)}>
            Become a Vendor
          </PrimaryButton>
        )}
            ...
            <form action="" onSubmit={updateVendor}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  value={data.store_address? data.store_address: ''}
              ...
              <div className="flex items-center gap-4">
                <PrimaryButton className="w-full" disabled={processing}>Update</PrimaryButton>
              </div>
            </form>
